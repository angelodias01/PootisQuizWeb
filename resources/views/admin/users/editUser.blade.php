...
<div class="flex-grow text-gray-800">
    ...
    <main class="p-6 sm:p-10 space-y-6">
        <div class="max-w-4xl mx-auto">
            ...
            @endif
            <br>
                <form action="{{ route('admin.users.updateUser', ['user' => $user->userId]) }}" method="POST" class="p-8 mt-6 lg:mt-0 border border-black border-3 rounded-lg bg-white">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        <label for="is_admin" class="block text-sm font-bold text-gray-600">Admin:</label>
