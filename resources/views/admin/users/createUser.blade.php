...
<div class="flex-grow text-gray-800">
    ...
    <main class="p-6 sm:p-10 space-y-6">
        <div class="max-w-4xl mx-auto">
            ...
            @endif
            <br>
                <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 mt-6 lg:mt-0 border border-black border-3 rounded-lg  bg-white">
                    @csrf

                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                            <label class="block text-gray-600 font-bold md:text-left pt-3 md:mb-0 pr-4" for="username">
                                Username
                            </label>
                        </div>
                        <div class="md:w-2/3">
                    ...
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                            <label class="block text-gray-600 font-bold md:text-left pt-3 md:mb-0 pr-4" for="email">
                                Email
                            </label>
                        </div>
                        <div class="md:w-2/3">
                    ...
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                            <label class="block text-gray-600 font-bold md:text-left pt-3 md:mb-0 pr-4" for="password">
                                Password
                            </label>
                        </div>
                        <div class="md:w-2/3">
                    ...
                    <div class="md:flex md:items-center md:justify-end">
                        ...
                        <div class="md:w-2/3 flex justify-end">
                            <button class="shadow bg-green-600 hover:bg-green-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-lg" type="submit">
                                Create User
                            </button>
                        </div>
                    </div>
