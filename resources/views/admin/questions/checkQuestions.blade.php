...
<div class="flex-grow text-gray-800">
    ...
    <main class="p-6 sm:p-10 space-y-6">
        @foreach($groupedQuestions as $themeName => $questions)
            <h2>{{ $themeName }}</h2>
...
{{-- CODIGO ANTES DA SOLUÇAO RASCA QUE ARRANJEI
    ...
    <main class="p-6 sm:p-10 space-y-6">
        <table class="border-collapse border border-gray-800">
            ...
            foreach ($questions as $question) {
                ...
                $themeName = Themes::where('themeId', $question->themeId)->value('themeName');
                echo '<td class="border border-gray-800 px-4 py-2">' . $themeName . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->questionsId . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->questionsText . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->correctAnswer . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->wrongAnswer1 . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->wrongAnswer2 . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->wrongAnswer3 . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2">' . $question->created_at . '</td>';
                echo '<td class="border border-gray-800 px-4 py-2"> <a href="' . route('check.all.questions') . '" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Edit</a></td>';
